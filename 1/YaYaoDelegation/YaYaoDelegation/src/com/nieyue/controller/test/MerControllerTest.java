...
import com.nieyue.controller.MerController;
...
public class MerControllerTest {
	@Resource
	MerController merController;
	@Resource
	...
	public void testBrowseMer() throws Exception {
		String url="/mer/list.xml?merStatus=1&orderName=mer_update_time&orderWay=desc&pageNum=3&pageSize=3";
